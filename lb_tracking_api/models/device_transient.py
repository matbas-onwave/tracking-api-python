...
class DeviceTransient(object):
    ...
    def __init__(self, type=None, duration=None, triggered_at=None, end=None, sent=None, sms=False, id=None, device_id=None, _configuration=None):  # noqa: E501
    ...
    def triggered_at(self, triggered_at):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and triggered_at is None:
