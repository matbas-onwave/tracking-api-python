...
class DeviceMessage(object):
    ...
    def __init__(self, config=None, message=None, mobile_terminated=True, created=None, sent=None, id=None, device_id=None, user_id=None, _configuration=None):  # noqa: E501
    ...
    def config(self, config):
        ...
        if (self._configuration.client_side_validation and
                config is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', config)):  # noqa: E501
