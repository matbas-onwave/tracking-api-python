...
class SensorReading(dict):
    ...
    def __init__(self, timestamp=None, created=None, type=None, value=None, meta=None, id=None, gateway_id=None, device_id=None, sensor_device_id=None, datapoint_id=None):  # noqa: E501
