...
class SensorReading(object):
    ...
    def __init__(self, timestamp=None, created=None, type=None, value=None, rssi=None, meta=None, related_id=None, id=None, gateway_id=None, device_id=None, sensor_device_id=None, datapoint_id=None):  # noqa: E501
